package com.sy.cfproject.tool.gpstool;
...
//    CarTrajectoryBean carHistoryLocationBean;
...
//        T.showToast(context,"路径规划失败 错误原因:"+s+"错误码:"+i);
        L.i("error :"+s);

//        GPSHistoryLine mHistory = new GPSHistoryLine(aMap,context);
